...
function selection(name, price, category){
  ...
  newItem.innerHTML = '<p class="col-8 fs-7 fw-bold mb-0">'+name+'</p><p class="item-price d-flex justify-content-end col-4 fs-7 fw-light mb-0">$'+price+'<a><svg viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg" class="delete-icon"></a></p>';
